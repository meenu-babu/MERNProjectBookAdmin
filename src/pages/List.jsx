  ...
  return (
    <div className='px-2 sm:px-8 mt-4 sm:mt-14'>
      <div className='flex flex-col gap-2'>
        <div className='grid grid-cols-[1fr_1fr_1.5fr_1.5fr_1fr] md:grid-cols-[1fr_1fr_1.5fr_1.5fr_1fr] items-center py-1 px-2 bg-blue-50/30 sm:mb-1 rounded'>
          <h5>Image</h5>
          <h5>Name</h5>
          <h5>Category</h5>
          <h5>Price</h5>
        ...
        {list.map((item) => (
          <div key={item._id} className='grid grid-cols-[1fr_1fr_1.5fr_1.5fr_1fr] md:grid-cols-[1fr_1fr_1.5fr_1.5fr_1fr] items-center gap-2 p-1 bg-blue-50/80 rounded-xl'>
